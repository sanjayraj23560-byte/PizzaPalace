...
const DrinkSection = () => {
  ...
  return (
    // 🌌 Premium Black Background Canvas  <div className="fixed inset-0 flex items-center justify-center">
      ...
      >
        {
          isLoading ? <div className="fixed inset-0 flex items-center justify-center">
            <CupSodaIcon size={40} className="animate-bounce text-green-500 rotate-12" />
          </div> : <>{
            drinks.map((d, index) => (
              <motion.div
                key={index}
